...
Rectangle {
    ...
    property color clipColor: isBlank ? 'transparent' : isTransition ? Bossa.Theme.magenta : isAudio ? Bossa.Theme.raised : Bossa.Theme.surface

    border.color: selected ? Bossa.Theme.cyan : Bossa.Theme.raised
    border.width: selected ? 2 : 1
    radius: Bossa.Theme.borderRadius
    clip: true
    ...
    Rectangle {
        ...
        anchors.fill: parent
        color: "transparent"
        border.color: Bossa.Theme.glowCyan
        border.width: 4
        visible: selected
