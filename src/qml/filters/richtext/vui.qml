...
Bossa.VuiBase {
    ...
    property string useFontSizeProperty: 'bossa:usePointSize'
    ...
    Component.onCompleted: {
        ...
        toolbar.expanded = filter.get('_bossa:toolbarCollapsed') !== '1';
        document.reset();
    }
    ...
    Flickable {
        ...
        Item {
            ...
            ToolBar {
                ...
                property bool expanded: filter.get('_bossa:toolbarCollapsed') !== '1'
                    ...
                    ToolButton {
                        ...
                        action: Action {
                            ...
                            onTriggered: {
                                ...
                                filter.set('_bossa:toolbarCollapsed', !toolbar.expanded);
                            }
                        }
                    }
                }
