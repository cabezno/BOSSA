...
Metadata {
    ...
    name: qsTr("Sharpen")
    keywords: qsTr('sharpness focus clear crisp', 'search keywords for the Sharpen video filter') + ' sharpen #gpu #10bit'
    mlt_service: "movit.sharpen"
    needsGPU: true
    qml: "ui_movit.qml"
    icon: 'icon.webp'
    help: 'https://forum.bossa.org/t/sharpen-video-filter/12880/1'
