...
void ScreenCapture::startRecording()
{
    ...
    case Interactive:
        ...
        connect(m_toolbar.get(),
                ...
                this,
                [this](int mode, bool minimizeBossa, bool recordAudio) {
...
void ScreenCapture::onCaptureModeSelected(CaptureMode mode, bool minimizeBossa, bool recordAudio)
{
