...
void AudioMeterWidget::calcGraphRect()
{
    ...
    m_gradient.setColorAt(IEC_ScaleMax(-90.0, m_maxDb), "#006666"); // Dark Cyan
    m_gradient.setColorAt(IEC_ScaleMax(-12.0, m_maxDb), "#00e5ff"); // SODA Cyan
    m_gradient.setColorAt(IEC_ScaleMax(-6.0, m_maxDb), "#f5d060");  // SODA Yellow
    m_gradient.setColorAt(IEC_ScaleMax(0.0, m_maxDb), "#e040fb");  // SODA Magenta
    if (m_maxDb > 0.0) {
        m_gradient.setColorAt(IEC_ScaleMax(m_maxDb, m_maxDb), "#660066"); // Dark Magenta
    }
}
